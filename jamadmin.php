...
<meta http-equiv="REFRESH" content="5;url=jamadmin.php">
...
//Abrimos una tabla
echo "<h5>usuarios  </h5>";
echo "<table border=6><tr><td>utc</td><td>usuarios</td><td>contrseña</td><td>nombre</td><td>email</td><td>fecha  de  nacimiento</td><td>titulo</td><td>borrar</td><td>modificar</td</tr>";
...
echo "<tr><td>".$fila['utc']."</td><td>".$fila['usuario']."</td><td>".$fila['contrasena']."</td><td>".$fila['nombre']."</td><td>".$fila['email']."</td><td>".$fila['fechanaci']."</td><td>".$fila['titulo']."</td><td></td><td></td></tr>";
...
$utc = $_GET['utc'];
$usuario = $_GET['usuariomod'];
$contrasena = $_GET['contracenamod'];
$nombre = $_GET['nombremod'];

$email = $_GET['emailmod'];
$fechanaci = $_GET['fechanacimod'];
...
<tr><td><input type="text" name="utc" size=30 value="<?php echo $utc; ?>" </td><td><input type="text" name="usuario" size=30 value="<?php echo $usuario; ?>"></td><td><input type="text" name="contrasena" size=30 value="<?php echo $contrasena; ?>"></td><td><input type="text" name="nombre" size=30 value="<?php echo $nombre; ?>"></td><td><input type="text" name="fechanaci" size=30 value="<?php echo $fechanaci; ?>"></td><td><input type="text" name="titulo" size=30 value="<?php echo $titulo; ?>"></td><td><input type="submit"> </td></tr></form>
...
//Abrimos una tabla
echo "<h5> SUBCATEGORIAS... </h5>";
echo "<table border=1><tr><td>utc</td><td>nombre  de la subcategoria</td><td>categoria</td><td>coneccion</td><td>foto</td><td>descripcion</td><td>enlace</td></tr>";
...
echo "<tr><td>".$fila['utc']."</td><td>".$fila['nombresubcategoria']."</td><td>".$fila['categoria']."</td><td>".$fila['coneccion']."</td><td>".$fila['foto']."</td><td>".$fila['descripcion']."</td><td>".$fila['enlace']."</td><tr>";
